export const ASSET_VAULT_ABI = [
	{
		inputs: [
			{ internalType: 'address', name: '_vaultManagerAddr', type: 'address' },
	...
	},
	{
		inputs: [
			{ internalType: 'address', name: '_asset', type: 'address' },
			{ internalType: 'uint256', name: '_valueUSD', type: 'uint256' },
		],
		name: 'estimateAssetAmount',
	...
	},
	{
		...
		outputs: [{ internalType: 'uint256', name: 'valueUSD', type: 'uint256' }],
		stateMutability: 'view',
		type: 'function',
	},
	{
		inputs: [{ internalType: 'address', name: '_asset', type: 'address' }],
		name: 'estimateAssetValueInUSD',
		outputs: [
	...
	{
		inputs: [{ internalType: 'uint8', name: '_newPoolFee', type: 'uint8' }],
		name: 'updatePoolFee',
		outputs: [],
		stateMutability: 'nonpayable',
		type: 'function',
	...
	{
		inputs: [{ internalType: 'uint8', name: '_newProfitFee', type: 'uint8' }],
